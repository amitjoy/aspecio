...
Aspecio 1.0.0 is the complete overhaul with a new proxy model that is simpler, completely unrestricted and faster. Refer to [Primeval Reflex](http://github.com/primeval-io/primeval-reflex) for the proxy capabilities.
