...
public final class AspectInterceptor implements Comparable<AspectInterceptor> {
    ...
    public AspectInterceptor(final String aspect, final Interceptor interceptor, final ServiceReference<?> serviceRef,
        ...
        this.aspect = requireNonNull(aspect, "'Aspect cannot be null'");
        this.interceptor = requireNonNull(interceptor, "'Interceptor cannot be null'");
        this.serviceRef = requireNonNull(serviceRef, "'Service reference cannot be null'");
